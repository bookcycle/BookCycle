                    ...
                    <div className="w-full max-w-sm">
                        ...
                        <form onSubmit={onSubmit} className="space-y-4">
                            ...
                            <button
                                ...
                                disabled={isLoading}
                                className="w-full inline-flex items-center justify-center gap-3 px-4 py-3 bg-white border border-[#1C1C1C20] rounded-lg text-[#1C1C1C] hover:bg-[#1C1C1C]/5 disabled:opacity-60"
                            >
                                <FaGoogle />
                            ...
                            <p className="text-center text-sm text-[#1C1C1C]">
                                ...
                                <button type="button" className="font-medium hover:opacity-80">
                                    Sign in
                                </button>
                            </p>
                        </form>
